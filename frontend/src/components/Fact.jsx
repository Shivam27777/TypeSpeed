...
export default function Fact() {
  ...
  return (
    <>
    <div class="flex items-center text-wrap  flex-col">
    
<blockquote class="px-5 text-xl italic font-semibold text-gray-900 dark:text-white min-w-214 max-w-220">
...
<button onClick={()=>getRandomFact()} class="sticky px-5 mx-2 bg-slate-300 box-border h-16 object-bottom ">
